...
package com.example.cookie.widget
...
import com.example.cookie.ui.MainActivity
import com.example.cookie.widget.data.RecentOrdersDataRepository
import com.example.cookie.widget.data.RecentOrdersDataRepository.Companion.getImageTextListDataRepo
import com.example.cookie.widget.layout.ImageTextListItemData
import com.example.cookie.widget.layout.ImageTextListLayout
                ...
                key(LocalSize.current) {
                    WidgetContent(
                        ...
                        shoppingCartActionIntent = Intent(
                            ...
                            .setData("https://cookie.example.com/home/cart".toUri()),
                    )
                }
            }
        }
