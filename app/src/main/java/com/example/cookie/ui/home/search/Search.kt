...
package com.example.cookie.ui.home.search
...
import com.example.cookie.model.Filter
import com.example.cookie.model.SearchCategoryCollection
import com.example.cookie.model.SearchRepo
import com.example.cookie.model.SearchSuggestionGroup
...
private fun SearchBar(
    ...
    CookieSurface(
        color = CookieTheme.colors.uiFloated,
        contentColor = CookieTheme.colors.textSecondary,
            ...
            Row(
                ...
                if (searchFocused) {
                    IconButton(onClick = onClearQuery) {
                        Icon(
                            ...
                            tint = CookieTheme.colors.iconPrimary,
                ...
                if (searching) {
                    CircularProgressIndicator(
                        color = CookieTheme.colors.iconPrimary,
                        modifier = Modifier
...
private fun SearchHint() {
    Row(
        ...
        Icon(
            ...
            tint = CookieTheme.colors.textHelp,
            contentDescription = stringResource(R.string.label_search),
        )
        Spacer(Modifier.width(8.dp))
        Text(
            text = stringResource(R.string.search_cookie),
