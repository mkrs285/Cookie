                    ...
                    IconButton(
                        ...
                        Icon(
                            ...
                            modifier = Modifier.diagonalGradientBorder(
                                colors = CookieTheme.colors.interactiveSecondary,
                                shape = CircleShape,
                            ),
                        )
                    }
...
fun FilterChip(filter: Filter, modifier: Modifier = Modifier, shape: Shape = MaterialTheme.shapes.small) {
    ...
    val backgroundColor by animateColorAsState(
        if (selected) CookieTheme.colors.brandSecondary else CookieTheme.colors.uiBackground,
    ...
    val textColor by animateColorAsState(
        if (selected) Color.Black else CookieTheme.colors.textSecondary,
        label = "text color",
    )
        ...
        val backgroundPressed =
            if (pressed) {
                Modifier.offsetGradientBackground(
                    CookieTheme.colors.interactiveSecondary,
                    200f,
                    0f,
                )
            } else {
